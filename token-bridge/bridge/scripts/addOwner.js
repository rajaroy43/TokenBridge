...
module.exports = async (callback) => {
  try {
    ...
    if (!newOwnerAddress) console.error("You need to pass new owner address");
    ...
    const result = await multiSig.contract.methods
      .submitTransaction(multiSigAddress, 0, addOwnerData)
