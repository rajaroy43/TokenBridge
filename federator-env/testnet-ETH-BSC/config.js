...
module.exports = {
  mainchain: require("./binancetestnet.json"), //the json containing the smart contract addresses in rsk
  sidechain: require("./kovantestnet.json"), //the json containing the smart contract addresses in eth
