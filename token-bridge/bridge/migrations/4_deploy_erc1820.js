...
module.exports = function(deployer, networkName, accounts) {
  deployer.then(() => {
    if (networkName === "development" || networkName === "rskregtest" || networkName === "soliditycoverage") {
...
const { ERC1820_REGISTRY_ABI, ERC1820_REGISTRY_ADDRESS, ERC1820_REGISTRY_DEPLOY_TX } = require(testHelperNodeMulesPath + "/src/data");
